...
%  Commit: checking 2x relationship between Vdiv and Vbirth PRIOR to
%          steady-stateS
...
for e = 1:length(exptArray)
    ...
    for condition = 1:length(bubbletime)
        ...
        % 14. calculate mean and standard deviation of birth and division volume
        ...
        % 15. initialize plotting parameters
        ...
        title(strcat('births before 2.5h :',date))
        axis([1 7 0 16])
