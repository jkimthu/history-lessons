%% M. birth size vs lambda for increments after a single downshift


%  Goal: what is the path between two steady-states?

%        plot birth volume vs mean growth rate from data just before
%        and for as long as possible after a single downsshift
...
exptArray = 26:27; % use corresponding dataIndex values
...
% 14. save data
save('M2_data.mat','cycleData','condArray','shape','palette','binsPerHour')
